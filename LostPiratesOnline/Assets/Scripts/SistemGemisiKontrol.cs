...
using System.Text;
public class SistemGemisiKontrol : NetworkBehaviour
{
    ...
    private int OdulTp = 0, OdulAltin = 0, odulElitPuan = 0;
    ...
    void Start()
    {
        ...
        {
            OdulTp = (int)(MaxCan / 200);
            OdulAltin = (int)(MaxCan / 200) * 5;
            odulElitPuan = (int)(MaxCan / 200) * odulElitPuanOrani;
    ...
    public void OdulVer()
    {
        for (int i = 0; i < 4; i++)
        {
            ...
            if (odulAlacakKisiler[i] != null)
            {
                ...
                {
                    // oyuncularýn verdikleri hasara göre ödül ayarlanýyor
                ...
                TargetOdulDonusu(opponentIdentity.connectionToClient, OdulTp, OdulAltin, odulElitPuan, GameManager.gm.BaskinHaritasiAdmiralNpcSayacPVP,GameManager.gm.BaskinHaritasiAdmiralNpcSayacPVE,HaritaKac);
                ...
                using (var command = GameManager.gm.sqliteConnection.CreateCommand())
                {
                    command.CommandText = "Update Kullanici SET BatirilanBot = BatirilanBot + 1 WHERE ID=@ID;";
                    command.Parameters.AddWithValue("@ID", odulAlacakKisiler[i].GetComponent<Player>().oyuncuId);
                    command.ExecuteNonQuery();
                }
                if (HaritaKac == 1&& odulAlacakKisiler[i].GetComponent<Player>().oyuncuTecrubePuan > 400)
                {
                    GameManager.gm.BenimGemim.GetComponent<Player>().SetOyuncuHaritaBirOnNpcKesmeGorevi(GameManager.gm.BenimGemim.GetComponent<Player>().haritaBirOnNpcKesGoreviSayac + 1);
                    GameManager.gm.BenimGemim.GetComponent<Player>().GorevKontrolu();
                    using (var command = GameManager.gm.sqliteConnection.CreateCommand())
                    {
                        command.CommandText = "Update Kullanici SET HaritaBirOnNpcKesmeGoreviSayac = HaritaBirOnNpcKesmeGoreviSayac + 1 WHERE ID=@ID;";
                        command.Parameters.AddWithValue("@ID", odulAlacakKisiler[i].GetComponent<Player>().oyuncuId);
                        command.ExecuteNonQuery();
                    }
                }
                else if (HaritaKac == 2 && odulAlacakKisiler[i].GetComponent<Player>().oyuncuTecrubePuan > 600)
                {
                    GameManager.gm.BenimGemim.GetComponent<Player>().SetOyuncuHaritaIkiOnNpcKesmeGorevi(GameManager.gm.BenimGemim.GetComponent<Player>().haritaIkiOnNpcKesGoreviSayac + 1);
                    GameManager.gm.BenimGemim.GetComponent<Player>().GorevKontrolu();
                    using (var command = GameManager.gm.sqliteConnection.CreateCommand())
                    {
                        command.CommandText = "Update Kullanici SET haritaIkiOnNpcKesGoreviSayac = HaritaBirOnNpcKesmeGoreviSayac + 1 WHERE ID=@ID;";
                        command.Parameters.AddWithValue("@ID", odulAlacakKisiler[i].GetComponent<Player>().oyuncuId);
                        command.ExecuteNonQuery();
                    }
                }
                else if (HaritaKac == 3 && odulAlacakKisiler[i].GetComponent<Player>().oyuncuTecrubePuan > 900)
                {
                    GameManager.gm.BenimGemim.GetComponent<Player>().SetOyuncuHaritaUcOnBesNpcKesmeGorevi(GameManager.gm.BenimGemim.GetComponent<Player>().haritaUcOnBesNpcKesGoreviSayac + 1);
                    GameManager.gm.BenimGemim.GetComponent<Player>().GorevKontrolu();
                    using (var command = GameManager.gm.sqliteConnection.CreateCommand())
                    {
                        command.CommandText = "Update Kullanici SET haritaUcOnBesNpcKesGoreviSayac = HaritaBirOnNpcKesmeGoreviSayac + 1 WHERE ID=@ID;";
                        command.Parameters.AddWithValue("@ID", odulAlacakKisiler[i].GetComponent<Player>().oyuncuId);
                        command.ExecuteNonQuery();
                    }
                }
                else if (HaritaKac == 4 && odulAlacakKisiler[i].GetComponent<Player>().oyuncuTecrubePuan > 1200)
                {
                    GameManager.gm.BenimGemim.GetComponent<Player>().SetOyuncuHaritaDortYirmiNpcKesmeGorevi(GameManager.gm.BenimGemim.GetComponent<Player>().haritaDortYirmiNpcKesGoreviSayac + 1);
                    GameManager.gm.BenimGemim.GetComponent<Player>().GorevKontrolu();
                    using (var command = GameManager.gm.sqliteConnection.CreateCommand())
                    {
                        command.CommandText = "Update Kullanici SET haritaDortYirmiNpcKesGoreviSayac = HaritaBirOnNpcKesmeGoreviSayac + 1 WHERE ID=@ID;";
                        command.Parameters.AddWithValue("@ID", odulAlacakKisiler[i].GetComponent<Player>().oyuncuId);
                        command.ExecuteNonQuery();
                    }
                }
                else if (HaritaKac == 5 && odulAlacakKisiler[i].GetComponent<Player>().oyuncuTecrubePuan > 4000)
                {
                    GameManager.gm.BenimGemim.GetComponent<Player>().SetOyuncuHaritaBesOtuzNpcKesmeGorevi(GameManager.gm.BenimGemim.GetComponent<Player>().haritaBesOtuzNpcKesGoreviSayac + 1);
                    GameManager.gm.BenimGemim.GetComponent<Player>().GorevKontrolu();
                    using (var command = GameManager.gm.sqliteConnection.CreateCommand())
                    {
                        command.CommandText = "Update Kullanici SET haritaBesOtuzNpcKesGoreviSayacs = HaritaBirOnNpcKesmeGoreviSayac + 1 WHERE ID=@ID;";
                        command.Parameters.AddWithValue("@ID", odulAlacakKisiler[i].GetComponent<Player>().oyuncuId);
                        command.ExecuteNonQuery();
                    }
                }
    ...
    [TargetRpc]
    public void TargetOdulDonusu(NetworkConnection target, int OdulTp, int OdulAltin, int OdulElitPuan,int donenBaskinHaritasiAdmiralNpcSayacPVP, int donenBaskinHaritasiAdmiralNpcSayacPVE,int donenHarita)
    {

        if (donenHarita == 97)
        {
#if UNITY_ANDROID
        GameManager.gm.EtkinlikSayaciAndroid.text = donenBaskinHaritasiAdmiralNpcSayacPVP + "/300";
#endif
#if UNITY_STANDALONE_WIN
            GameManager.gm.EtkinlikSayaciWin.text = donenBaskinHaritasiAdmiralNpcSayacPVP + "/300";
#endif
        }
        else if (donenHarita == 98)
        {
#if UNITY_ANDROID
        GameManager.gm.EtkinlikSayaciAndroid.text = donenBaskinHaritasiAdmiralNpcSayacPVE + "/300";
#endif
#if UNITY_STANDALONE_WIN
            GameManager.gm.EtkinlikSayaciWin.text = donenBaskinHaritasiAdmiralNpcSayacPVE + "/300";
#endif
        }
        ...
        if (OdulElitPuan > 0)
        {
            ...
            {
                GameManager.gm.OdulText.GetComponent<Text>().text = geminame + GameManager.gm.dilDegistirme.GetComponent<Dildegistirme>().EkranaYazilacakOlan[PlayerPrefs.GetInt("dil"), 247] + OdulTp + GameManager.gm.dilDegistirme.GetComponent<Dildegistirme>().EkranaYazilacakOlan[PlayerPrefs.GetInt("dil"), 253] + OdulAltin + GameManager.gm.dilDegistirme.GetComponent<Dildegistirme>().EkranaYazilacakOlan[PlayerPrefs.GetInt("dil"), 250]+ OdulElitPuan + GameManager.gm.dilDegistirme.GetComponent<Dildegistirme>().EkranaYazilacakOlan[PlayerPrefs.GetInt("dil"), 568];
                GameManager.gm.OdulYazisiSayacBaslat();
            }
            else if (GameManager.gm.OdulText.GetComponent<Text>().text != null)
            {
                GameManager.gm.OdulText2.GetComponent<Text>().text = geminame + GameManager.gm.dilDegistirme.GetComponent<Dildegistirme>().EkranaYazilacakOlan[PlayerPrefs.GetInt("dil"), 247] + OdulTp + GameManager.gm.dilDegistirme.GetComponent<Dildegistirme>().EkranaYazilacakOlan[PlayerPrefs.GetInt("dil"), 253] + OdulAltin + GameManager.gm.dilDegistirme.GetComponent<Dildegistirme>().EkranaYazilacakOlan[PlayerPrefs.GetInt("dil"), 250] + OdulElitPuan + GameManager.gm.dilDegistirme.GetComponent<Dildegistirme>().EkranaYazilacakOlan[PlayerPrefs.GetInt("dil"), 568];
                GameManager.gm.OdulYazisiSayacBaslat();
                return;
            }
            GameManager.gm.AddItemsSeyirDefteri(geminame + GameManager.gm.dilDegistirme.GetComponent<Dildegistirme>().EkranaYazilacakOlan[PlayerPrefs.GetInt("dil"), 247] + OdulTp + GameManager.gm.dilDegistirme.GetComponent<Dildegistirme>().EkranaYazilacakOlan[PlayerPrefs.GetInt("dil"), 253] + OdulAltin + GameManager.gm.dilDegistirme.GetComponent<Dildegistirme>().EkranaYazilacakOlan[PlayerPrefs.GetInt("dil"), 250] + OdulElitPuan + GameManager.gm.dilDegistirme.GetComponent<Dildegistirme>().EkranaYazilacakOlan[PlayerPrefs.GetInt("dil"), 568]);
    ...
    IEnumerator GemiOldur()
    {
        if (HaritaKac == 98)
        {
            GameManager.gm.BaskinHaritasiAdmiralNpcSayacPVE += 1;
            GameManager.gm.BaskinHaritalariAdmiralDogumKontrolu();
        }
        else if (HaritaKac == 97)
        {
            GameManager.gm.BaskinHaritasiAdmiralNpcSayacPVP += 1;
            GameManager.gm.BaskinHaritalariAdmiralDogumKontrolu();
        }
        else
        {
            GameManager.gm.AdmiralHaritaNpcSayac[HaritaKac - 1] += 1;
            GameManager.gm.AdmiralDogumKontrolu();
        }
    ...
    {
        GameManager.gm.NpcDogurSunucu(name, HaritaKac);
        GameManager.gm.BaskinHaritasiNpcDogurSunucu(name, HaritaKac);
    }
